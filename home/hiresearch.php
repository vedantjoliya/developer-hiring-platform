...
<body>
    ...
    <div class="section1">
        ...
        <form class="form" method="POST" action="hiresearch.php">
            <input type="text" name="search" class="longg" placeholder="Enter search text..." required>
            ...
            if (!empty($searchResults)) {
                foreach ($searchResults as $row) {
                    ...
                    <article class="developer-card" id="developer-<?php echo htmlspecialchars($row['user_id']); ?>">
                        ...
                        <h3>Designation: <?php echo htmlspecialchars($row['desig']); ?></h3>
                        <p><strong>Skills:</strong> <?php echo htmlspecialchars($row['skill']); ?></p>
                        <p><strong>LinkedIn:</strong> <a
                                href=" <?php echo htmlspecialchars($row['linkedin']); ?>"><?php echo htmlspecialchars($row['linkedin']); ?></a>
                        </p>
                        <p><strong>Work Description:</strong>
                            <?php echo htmlspecialchars($row['work']); ?></p>
